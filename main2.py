...
prédéfini.
Apprendre sur l’ensemble « train » en stoppant l’erreur d’apprentissage Ea fixé à l’avance,
puis tester la généralisation Eg sur l’ensemble de test.
Tester aussi l’initialisation aléatoire vs une initialisation de Hebb. Refaire les expériences
en échangeant les données « train » et « test ». Que pouvez vous dire de Ea et Eg en
fonction des ensembles? et en fonction de l’initialisation? En fonction du eta (pas
d’apprentissage)? Montrer vos résultats sous forme de tables ou de graphiques (bonus).
